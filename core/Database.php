 ...
 * @git: https://github.com/rorystandley/MySQL-CRUD-PHP-OOP
 * @Version 1.3
 * @Package Database
 */
class Database{
	 ...
	 * 
	 */
	private $con = false; // boolean - Check to see if the connection is active
	private $result = array(); // Array para guardar los datos consultados en una sentencia SQL o Query , Any results from a query will be stored here
    private $myQuery = "";// used for debugging process with SQL return
    private $numResults = "";// used for returning the number of rows
	
	/**
	 * Establece conexion con la bbdd mediante los atributos privados de esta clase:
	 * <ul>
	 *   <li>$db_host: servidor</li>
	 *   <li>$db_user: usuario</li>
	 *   <li>$db_pass: password</li>
	 *   <li>$db_name: nombre bbdd</li>
	 * </ul>
     ...
     * @return boolean true si se ejecuta, false en caso contrario
     */
	...
	/**
	 * Ejecutar sentencias SQL de consulta 'SELECT'
	 * @param string $table nombre tabla
	 * @param string $rows  nombre de las columnas a retornar
	 * @param string $join  unir dos tablas
	 * @param string $where especificar condiciones
	 * @param string $order indicar el order a retornar
	 * @param string $limit numero maximo filas a retornar
	 * @return boolean
	 */
